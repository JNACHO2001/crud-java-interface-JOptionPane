package com.mycompany.mini.crud;
...
public class CrudProductos extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("productos     precios");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {
           ...
           float precio = Float.parseFloat(txtPrecio.getText().trim());
            ...
            JOptionPane.showMessageDialog(this, "Precio inválido o producto invalido");
        }
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        if (index != -1) {
            ...
            JOptionPane.showMessageDialog(this, "Selecciona un producto de la lista para eliminar");
        }
